...
§ main.users.boss.description1: 無職人の特定
§ main.users.boss.description2: amount of code
§ main.users.boss.description3: 作業速度を確認する
§ main.users.boss.description4: 行動の異常を発見する
§ main.users.boss.description5: dynamics of work by week
§ main.users.ceo.title: Founder
§ main.users.ceo.description1: 製品の価格
§ main.users.ceo.description2: 新機能の価格
§ main.users.ceo.description3: 開発時間
§ main.users.ceo.description4: 改善時間の予測
§ main.users.ceo.description5: 予測価格
