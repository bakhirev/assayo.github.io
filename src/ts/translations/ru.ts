...
§ main.feature.description3: Интегрируем с вашим таск-трекером
§ main.feature.description4: Встроим в другие b2b решения
...
§ main.comments.user1.name: Александр Гофман
...
§ main.comments.user2.name: Антон Хан
...
§ main.comments.user4.name: Марат Сафин
...
§ main.footer.copy: Все права защищены
`;
